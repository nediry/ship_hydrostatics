...
# wl2 = np.array([0, 0.5, 1, 2, 3, 4, 4*1.35, 4*1.70]) * 30 #ITU
wl2 = np.array([0, 0.5, 1, 2, 3, 4, 4*1.325, 4*1.65]) * 32.9416453 #PRU
# wl2 = np.array([0, 0.5, 1, 2, 3, 4, 5, 6]) * 32.9416453  #YTU
alan_oran = np.max(alan)/37.3
alan1 = alan / alan_oran
print('_Curve')
for i in range(8):
    print(str(alan1[1,i] + 0.5*37.4074)+','+str(wl2[i]))
print('enter')
print('_Curve')
for i in range(8):
...
print('_Curve')
for i in range(8):
    print(str(moment1[1,i]+0.5*37.4074)+','+str(wl2[i]))
print('enter')
print('_Curve')
for i in range(8):
...
CB_oran = 37.4074*0.5 / (np.max(CB) + 1)
CB1 = CB * CB_oran
print('_Curve')
for i in range(1, col):
...
oran = 37.4074*0.5 / (np.max(CW) + 0.1)
CW1 = CW * oran
print('_Curve')
for i in range(1, col):
...
oran = 37.407*0.5 / (np.max(CP) + 0.1)
CP1 = CP * oran
print('_Curve')
for i in range(1, col):
    print(str(CP1[i]+37.4074*0.5)+','+str(wl2[i]))
print('enter')
